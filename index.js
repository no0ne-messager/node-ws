...
const UUID = process.env.UUID || '097c9441-19e0-4839-91b2-bb6facfa6470'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || '097c9441-19e0-4839-91b2-bb6facfa6470';            // 获取节点的订阅路径
const NAME = process.env.NAME || '';                       // 节点名称
const PORT = process.env.PORT || 3001;                     // http和ws服务端口
